#!/usr/bin/env python3
"""
Create Four Elite Accounts
Account 1: Mom / Nash6274
Account 2: MikeS / MikeS
Account 3: GregS / GregS
Account 4: Schuess / Nash6274
"""
...
if __name__ == "__main__":
    print("\n" + "="*60)
    print("CREATING FOUR ELITE ACCOUNTS")
    print("="*60)
    ...
    success2 = create_elite_account(
        username="MikeS",
        password="MikeS",
        email="mikes@maxevsports.com",
        full_name="MikeS"
    )

    # Account 3: GregS
    success3 = create_elite_account(
        username="GregS",
        password="GregS",
        email="gregs@maxevsports.com",
        full_name="GregS"
    )

    # Account 4: Schuess
    success4 = create_elite_account(
        username="Schuess",
        password="Nash6274",
        email="schuess@maxevsports.com",
        full_name="Schuess"
    )

    if success1 and success2 and success3 and success4:
        print("\n" + "="*60)
        print("ALL FOUR ACCOUNTS CREATED SUCCESSFULLY")
        print("="*60)
        print("\nAccount 1:")
        print("  Username: Mom")
        print("  Password: Nash6274")
        print("\nAccount 2:")
        print("  Username: MikeS")
        print("  Password: MikeS")
        print("\nAccount 3:")
        print("  Username: GregS")
        print("  Password: GregS")
        print("\nAccount 4:")
        print("  Username: Schuess")
        print("  Password: Nash6274")
