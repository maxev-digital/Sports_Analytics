"""
XGBoost Model for NBA Spreads Prediction
Captures complex feature interactions with built-in regularization

Per sports-betting-models-guide.md:
- Handles complex feature interactions
- Built-in regularization
- Fast predictions
- 65.3% ATS accuracy in training
"""
...
class XGBoostSpreadsModel:
    """XGBoost model for predicting NBA spreads (home margin)"""
    ...
    def __init__(self):
        ...
        self.model = joblib.load(model_dir / "nba_xgboost_spreads_latest.joblib")
    ...
    def predict(self, game_data: Dict, market_spread: Optional[float] = None) -> Dict:
        ...
        # Get prediction from XGBoost (home margin)
        prediction = self.model.predict(features)[0]

        # XGBoost confidence based on performance
        confidence = 0.70
        std_dev = 4.9
...
def get_nba_xgboost_spreads_model():
