"""
Random Forest Classifier for NBA Moneyline Prediction
Predicts straight-up winner with win probabilities

Per sports-betting-models-guide.md:
- Captures complex winning factors
- Non-linear decision boundaries
- 66.67% accuracy in training
- 0.7205 ROC-AUC score
"""
...
class RandomForestMoneylineModel:
    """Random Forest Classifier model for predicting NBA moneyline (winner)"""
    ...
    def __init__(self):
        ...
        self.model = joblib.load(model_dir / "nba_random_forest_classifier_moneyline_latest.joblib")
        metadata = joblib.load(model_dir / "nba_moneyline_metadata_latest.joblib")

        self.feature_names = metadata['feature_names']
        stats = metadata['training_stats']['random_forest_classifier']
...
def get_nba_random_forest_moneyline_model():
