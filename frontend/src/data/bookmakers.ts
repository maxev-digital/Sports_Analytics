...
export const BOOKMAKERS: Record<string, Bookmaker> = {
  ...
  sugarhousepa: {
    ...
    region: ['US'],
    logo: getLogoUrl('sugarhousepa', false),
  ...
  sugarhousenj: {
    ...
    region: ['US'],
    logo: getLogoUrl('sugarhousenj', false),
  ...
  riverscasinopa: {
    ...
    region: ['US'],
    logo: getLogoUrl('riverscasinopa', false),
  ...
  prophetx: {
    ...
    region: ['US'],
    logo: getLogoUrl('prophetx', false),
  ...
  consensus: {
    ...
    url: '#',
    region: ['US'],
    logo: getLogoUrl('consensus', false),
