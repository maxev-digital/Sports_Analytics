...
export const BOOKMAKERS: Record<string, Bookmaker> = {
  ...
  pointsbet: {
    ...
    region: ['US'],
    logo: getLogoUrl('pointsbet', true),
  ...
  williamhill_us: {
    ...
    region: ['US'],
    logo: getLogoUrl('williamhill_us', true),
  ...
  prizepicks: {
    ...
    region: ['US'],
    logo: getLogoUrl('prizepicks', true),
  ...
  sugarhousepa: {
    key: 'sugarhousepa',
    name: 'SugarHouse PA',
    url: 'https://pa.sugarhousecasino.com/sports',
    region: ['US'],
    logo: getLogoUrl('sugarhousepa', true),
    logoFallback: getLogoUrl('sugarhousepa', false),
  },
  sugarhousenj: {
    key: 'sugarhousenj',
    name: 'SugarHouse NJ',
    url: 'https://nj.sugarhousecasino.com/sports',
    region: ['US'],
    logo: getLogoUrl('sugarhousenj', true),
    logoFallback: getLogoUrl('sugarhousenj', false),
  },
  parx: {
    key: 'parx',
    name: 'Parx Casino',
    url: 'https://pa.parxcasino.com/sports',
    region: ['US'],
    logo: getLogoUrl('parx', true),
    logoFallback: getLogoUrl('parx', false),
  },
  riverscasinopa: {
    key: 'riverscasinopa',
    name: 'Rivers Casino PA',
    url: 'https://pa.riverscasino.com/sports',
    region: ['US'],
    logo: getLogoUrl('riverscasinopa', true),
    logoFallback: getLogoUrl('riverscasinopa', false),
  },
  circa: {
    key: 'circa',
    name: 'Circa Sports',
    ...
    region: ['US'],
    logo: getLogoUrl('circa', true),
    logoFallback: getLogoUrl('circa', false),
  },
  sleeper: {
    key: 'sleeper',
    name: 'Sleeper',
    ...
    region: ['US'],
    logo: getLogoUrl('sleeper', true),
    logoFallback: getLogoUrl('sleeper', false),
  },
  prophetx: {
    key: 'prophetx',
    name: 'ProphetX',
    url: 'https://prophetexchange.com/',
    region: ['US'],
    logo: getLogoUrl('prophetx', true),
    logoFallback: getLogoUrl('prophetx', false),
  },
  consensus: {
    key: 'consensus',
    name: 'Consensus',
    url: '#',
    region: ['US'],
    logo: getLogoUrl('consensus', true),
    logoFallback: getLogoUrl('consensus', false),
  },
  ballybet: {
    key: 'ballybet',
    name: 'Bally Bet',
  ...
  superbook: {
    ...
    region: ['US'],
    logo: getLogoUrl('superbook', true),
  ...
  twinspires: {
    ...
    region: ['US'],
    logo: getLogoUrl('twinspires', true),
  ...
  mybookieag: {
    ...
    region: ['US', 'Global'],
    logo: getLogoUrl('mybookieag', true),
  ...
  bookmaker: {
    ...
    region: ['Global'],
    logo: getLogoUrl('bookmaker', true),
  ...
  intertops: {
    ...
    region: ['Global'],
    logo: getLogoUrl('intertops', true),
  ...
  williamhill: {
    ...
    region: ['UK', 'EU'],
    logo: getLogoUrl('williamhill', true),
  ...
  ladbrokes: {
    ...
    region: ['UK', 'AU'],
    logo: getLogoUrl('ladbrokes', true),
  ...
  paddypower: {
    ...
    region: ['UK', 'IE'],
    logo: getLogoUrl('paddypower', true),
  ...
  virginbet: {
    ...
    region: ['UK'],
    logo: getLogoUrl('virginbet', true),
  ...
  matchbook: {
    ...
    region: ['UK', 'EU'],
    logo: getLogoUrl('matchbook', true),
  ...
  livescorebet: {
    ...
    region: ['UK'],
    logo: getLogoUrl('livescorebet', true),
  ...
  sportsbet: {
    ...
    region: ['AU'],
    logo: getLogoUrl('sportsbet', true),
  ...
  picklebet: {
    ...
    region: ['AU'],
    logo: getLogoUrl('picklebet', true),
  ...
  nordicbet: {
    ...
    region: ['EU'],
    logo: getLogoUrl('nordicbet', true),
  ...
  unibet_eu: {
    ...
    region: ['EU'],
    logo: getLogoUrl('unibet_eu', true),
  ...
  sport_interaction: {
    ...
    region: ['CA'],
    logo: getLogoUrl('sport_interaction', true),
  ...
  betvictor: {
    ...
    region: ['CA', 'UK', 'EU'],
    logo: getLogoUrl('betvictor', true),
