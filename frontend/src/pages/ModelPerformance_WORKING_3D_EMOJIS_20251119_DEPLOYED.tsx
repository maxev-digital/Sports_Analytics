...
export function ModelPerformance() {
  ...
  const sports = [
    { key: 'all', name: 'All Sports', emoji: 'https://em-content.zobj.net/source/microsoft-teams/363/bullseye_1f3af.png' },
    { key: 'nba', name: 'NBA', emoji: 'https://em-content.zobj.net/source/microsoft-teams/363/basketball_1f3c0.png' },
    { key: 'ncaab', name: 'NCAAB', emoji: 'https://em-content.zobj.net/source/microsoft-teams/363/basketball_1f3c0.png' },
    { key: 'nfl', name: 'NFL', emoji: 'https://em-content.zobj.net/source/microsoft-teams/363/american-football_1f3c8.png' },
    { key: 'nhl', name: 'NHL', emoji: 'https://em-content.zobj.net/source/microsoft-teams/363/ice-hockey_1f3d2.png' },
    { key: 'ncaaf', name: 'NCAAF', emoji: 'https://em-content.zobj.net/source/microsoft-teams/363/american-football_1f3c8.png' },
  ];
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {Object.entries(overview.by_confidence).map(([level, stats]: [string, any]) => {
                const confidenceConfig = {
                  'high': { gradient: 'from-green-900/60 to-green-800/30 border-green-600', icon: 'https://em-content.zobj.net/source/microsoft-teams/363/fire_1f525.png' },
                  'medium': { gradient: 'from-yellow-900/60 to-yellow-800/30 border-yellow-600', icon: 'https://em-content.zobj.net/source/microsoft-teams/363/high-voltage_26a1.png' },
                  'low': { gradient: 'from-blue-900/60 to-blue-800/30 border-blue-600', icon: 'https://em-content.zobj.net/source/microsoft-teams/363/light-bulb_1f4a1.png' },
                };
                  ...
                  <div key={level} className={`bg-gradient-to-br ${config.gradient} border-2 rounded-lg p-6`}>
                    <div className="flex justify-between items-start mb-4">
                      <div className="flex items-center gap-2">
                        <img src={config.icon} alt="" className="w-8 h-8" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {Object.entries(overview.by_sport)
                ...
                .map(([sportKey, stats]: [string, any]) => {
                  const sportInfo = sports.find(s => s.key === sportKey) || { emoji: '🎯', name: sportKey.toUpperCase() };
                  const gradients = [
