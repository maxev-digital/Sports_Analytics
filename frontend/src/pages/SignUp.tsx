      ...
      <div className="max-w-md w-full space-y-6">
        <div className="text-center relative">
          <img
            ...
            className={`mx-auto h-64 w-auto mb-6 mix-blend-screen transition-all duration-500 ${showFireRing ? 'scale-110 brightness-125 drop-shadow-[0_0_30px_rgba(59,130,246,0.8)]' : ''}`}
          />
          <h2 className="text-center text-4xl font-bold text-white">
            Create Your Max EV Account
          </h2>
